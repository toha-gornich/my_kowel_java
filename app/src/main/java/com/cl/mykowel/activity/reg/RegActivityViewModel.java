...
public class RegActivityViewModel extends ViewModel {
    ...
    public void createNewUser(User user, Context context) {
        ...
        Call<User> call = retroServiceInterface.postUserReg(createPartFromString(user.getLogin()),createPartFromString(user.getName()), createPartFromString(user.getEmail()), createPartFromString(user.getPhone()),createPartFromString(user.getPassword()));
